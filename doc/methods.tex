...
As reported in Macrostrat: max thickness (positive, real), contact with units above (binary), contact with units below (binary), distance traveled between bottom and top coordinate in kilometers (positive, real), if unit began in tropical latitudes (binary), if unit is strictly subsurface or not (binary), and the percent composition of carbonate and siliciclastic lithologies (compositional). 

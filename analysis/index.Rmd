...
# either accomplishes the same task 
# requires the compendium installed as a package
library(notfossil)


# does not require installing compendium

#library(pacman)
#
#p_load(here, janitor, readr, magrittr, dplyr, tidyr, purrr, glue, stringr, 
